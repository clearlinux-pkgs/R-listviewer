...
Version  : 2.0.0
Release  : 1
URL      : https://cran.r-project.org/src/contrib/listviewer_2.0.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/listviewer_2.0.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1532696525
...
R CMD check --no-manual --no-examples --no-codoc -l %{buildroot}/usr/lib64/R/library listviewer|| : 
cp ~/.stash/* %{buildroot}/usr/lib64/R/library/*/libs/ || :
